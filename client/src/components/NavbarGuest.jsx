      ...
      <nav class="bg-transparent w-full">
        <div class=" flex flex-wrap items-center justify-between px-10 py-2">
          <a href="/" class="flex items-center">
            <img src={appLogo} class="h-16 mr-3 rounded-full" alt="Flowbite Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">tHONTHRON HR System</span>
          </a>
