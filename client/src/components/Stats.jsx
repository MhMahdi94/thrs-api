...
const Stats = () => {
  ...
  return (
    <div>
      <div class="flex items-start  bg-gray-100">
          ...
          {user.role == 'super' ?
            <div class="grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
              <StatCard label='Requests'
                ...
                value={10}
              />
              <StatCard label='Companies'
                icon={
                  <svg class="w-5 h-5 text-white transition duration-75  group-hover:text-red-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 18 18">
