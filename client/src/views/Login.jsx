  ...
  return (
    ...
    <div className="h-screen md:flex ">
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form className="bg-white w-96" onSubmit={handleLogin}>
          {/* <img src={appLogo} className='h-48 w-48'/> */}
          ...
          <Input
            ...
            required={true}
          />
          <button type="submit" className="block w-full bg-red-900 mt-8 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
